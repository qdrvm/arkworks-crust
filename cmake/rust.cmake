...
if (BUILD_SHARED_LIBS)
  set(lib ${path_prefix}/${CMAKE_SHARED_LIBRARY_PREFIX}arkworks_crust${CMAKE_SHARED_LIBRARY_SUFFIX})
else ()
  set(lib ${path_prefix}/${CMAKE_STATIC_LIBRARY_PREFIX}arkworks_crust${CMAKE_STATIC_LIBRARY_SUFFIX})
endif ()
message(STATUS "[arkworks] library: ${lib}")


set(include_path ${PROJECT_SOURCE_DIR}/include)
set(arkworks_h_dir ${include_path}/arkworks)
...
add_library(arkworks_crust STATIC IMPORTED GLOBAL)
...
if (NOT BUILD_SHARED_LIBS)
  if (APPLE)
    ...
    set_target_properties(arkworks_crust PROPERTIES
        INTERFACE_LINK_LIBRARIES ${Security}
        )
  elseif (UNIX)
    # on Linux we need to link pthread
    target_link_libraries(arkworks_crust INTERFACE
        pthread
        -Wl,--no-as-needed
        dl
        )
...
install(
    FILES ${PROJECT_SOURCE_DIR}/cmake/arkworks_crustConfig.cmake
    DESTINATION ${CMAKE_INSTALL_LIBDIR}/cmake/arkworks_crust
)
